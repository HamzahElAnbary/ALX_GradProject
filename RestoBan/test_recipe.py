...
class RecipeTests(TestCase):
    ...
    def test_create_validation(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertFormError(resp, "form", "title", "Title is required.")
        self.assertFormError(resp, "form", "ingredients", "At least one ingredient is required (one per line).")
        self.assertFormError(resp, "form", "instructions", "Instructions are required.")
